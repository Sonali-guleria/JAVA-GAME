/* Author- Sonali Guleria
   ...
   Description- Project 2 and Activity 2-Play Rainbow Explosion with.
   player loads a secret list by giving a path which is the source of the secret word.
   ...
   Modification: Removed the functionality of getting the file from user. Commented the code. can be used if want to use in future
...
public class P2A2_GULERIA_SONALI extends P2A2_GULERIA_SONALI_WORDLIST {
    ...
    public static void main(String[] args) {
   	...
   	P2A2_GULERIA_SONALI Starter = new P2A2_GULERIA_SONALI();                                       //an object created for class GuessWord    
   	 ...
   	 try {
   		   ...
   		   /* System.out.println("\nPlease give full path of your file");
   		    String filePath = Starter.answer.nextLine();*/    //  to get file path from user
   		        ...
   		        //File dir = new File(".");
   		        //File filepath = new File(dir.getCanonicalPath()+ File.separator + "P2A2_GULERIA_SONALI.txt");
   		        
   		        File filePath = new File("P2A2_GULERIA_SONALI.txt");
   	   ...
   	   {
			System.out.println("File Not Found at " +"Make sure it exists.");
		}
   	 ...
   	 Starter.listSize = Starter.numWords();
   	    ...
   	    do{	
   	    	...
   	    	Starter.guessMe = Starter.getRandomWord(Starter.listSize);
